...
void List_Dispose( List *list ) {
	while (list->firstElement != NULL) List_DeleteFirst(list);
	List_Init(list);
}
...
void List_InsertFirst( List *list, int data ) {
	struct ListElement *temporary = list->firstElement;
...
void List_DeleteFirst( List *list ) {
	if (list->firstElement != NULL) {
		struct ListElement *temporary = list->firstElement->nextElement;
...
void List_DeleteAfter( List *list ) {
	if (list->activeElement != NULL && list->activeElement->nextElement != NULL) {	
		struct ListElement *temporary = list->activeElement->nextElement->nextElement;
...
void List_InsertAfter( List *list, int data ) {
	if (list->activeElement != NULL) {
		struct ListElement *temporary = list->activeElement->nextElement;
		list->activeElement->nextElement = malloc(sizeof(struct ListElement));
		if (list->activeElement->nextElement == NULL) List_Error();
		else {
